...
`
	...
	const sdkTag =
		versions.sdkVersions[appJson.expo.sdkVersion].expoReactNativeTag
	...
	if (code === 0) {
      ...
      ${chalk.yellow(
			`Please install react-native@${reactNativeVersion} before continuing.`
		)}
    `
		)
	}
